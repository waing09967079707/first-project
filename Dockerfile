...
ONBUILD RUN ln -sfn "${ODOO_BASEPATH}/vendor${LAYER_SUFFIX}" "${ODOO_BASEPATH}/vendor"; \
            ln -sfn "${ODOO_BASEPATH}/src${LAYER_SUFFIX}" "${ODOO_BASEPATH}/src"; \
            /patches ${ODOO_BASEPATH} || true
